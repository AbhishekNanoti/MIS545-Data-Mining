...
hotelCancellation <- hotelCancellation %>%
  mutate(hotelResort = hotelresort,
         hotelCity = hotelcity,
         marketOnlineTA = marketonlineta,
         marketOfflineTATO = marketofflinetato,
         customerParty = customerparty
  ) %>%
  select(-c(hotelresort,hotelcity,marketonlineta,
            marketofflinetato,customerparty))
...
# testing dataset
sum(diag(hotelCancellationConfusionMatrix))/
